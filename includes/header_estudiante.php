...
<head>
    ...
    <title>Panel de Estudiante - Cobra Team</title>
...
<body>
    ...
    <header class="navbar">
        ...
        <nav class="nav-links">
            ...
            <a href="mis_clases.php" class="<?php echo ($pagina_actual == 'mis_clases') ? 'active' : ''; ?>">Mis Clases</a>
            <a href="mi_progreso.php" class="<?php echo ($pagina_actual == 'progreso') ? 'active' : ''; ?>">Mi Progreso</a>
            <a href="pagos.php" class="<?php echo ($pagina_actual == 'pagos') ? 'active' : ''; ?>">Pagos</a>
        </nav>
